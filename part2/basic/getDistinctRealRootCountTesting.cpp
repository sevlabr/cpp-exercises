...
int GetDistinctRootSquare(double a, double b, double c) {
	int D = b*b - 4*a*c;
	if (D == 0) {
		return 1;
	} else if (D > 0) {
...
int GetDistinctRootLinear(double b, double c) {
	if (b == 0) {
		return 0;
	}
	return 1;
...
int GetDistinctRealRootCount(double a, double b, double c) {
  ...
  if (a == 0) {
	  return GetDistinctRootLinear(b, c);
  } else {
	  return GetDistinctRootSquare(a, b, c);
  }
}
...
void TestGetDistinctRealRootCount() {
	{
		int result = GetDistinctRealRootCount(0, 0, 1);
	  	AssertEqual(result, 0, "1 = 0");
	}
	{
		int result = GetDistinctRealRootCount(0, 1, 0);
	  	AssertEqual(result, 1, "x = 0");
	}
	{
		int result = GetDistinctRealRootCount(0, 1, 1);
		AssertEqual(result, 1, "x + 1 = 0");
	}
	{
		int result = GetDistinctRealRootCount(1, 0, 0);
	  	AssertEqual(result, 1, "x^2 = 0");
	}
	{
		int result = GetDistinctRealRootCount(1, 1, 0);
		AssertEqual(result, 2, "x^2 + x = 0");
	}
	{
		int result = GetDistinctRealRootCount(1, 1, 1);
		AssertEqual(result, 0, "x^2 + x + 1= 0");
	}
	{
		int result = GetDistinctRealRootCount(1, 2, 1);
		AssertEqual(result, 1, "x^2 + 2x + 1 = 0");
	}
	{
		int result = GetDistinctRealRootCount(1, 3, 2);
		AssertEqual(result, 2, "x^2 + 3x + 2 = 0");
	}
	{
		int result = GetDistinctRealRootCount(1, 0, 2);
		AssertEqual(result, 0, "x^2 + 2 = 0");
	}
	{
		int result = GetDistinctRealRootCount(1, 0, -2);
		AssertEqual(result, 2, "x^2 - 2 = 0");
	}
}
