...
void TestDatabase() {
  ...
  // Add 2 - Del 1 - Add deleted again
  {
    ...
    db.Add(d, "e1");
    AssertEqual(db.FindIf(empty_predicate).size(), static_cast<size_t>(2), "Db Add2-Del-Add 2");
  }
  ...
  // Add
  {
    ...
    AssertEqual(db.FindIf(predicate).size(), static_cast<size_t>(1), "Db Add Duplicates 1");
  }
  ...
  // Find
  {
    ...
    AssertEqual(db.FindIf(predicate).size(), static_cast<size_t>(2), "Db Find 1");
  }
  {
    Database db;
    db.Add({2019, 1, 1}, "e1");
    ...
    AssertEqual(db.FindIf(predicate).size(), static_cast<size_t>(4), "Db Find 2");
  }
  {
    Database db;
    db.Add({2019, 1, 1}, "e1");
    ...
    db.Add({2018, 1, 7}, "e3");
    db.Add({2018, 1, 7}, "e4");
    AssertEqual(db.FindIf(empty_predicate).size(), static_cast<size_t>(4), "Db Find 3");
  }
  {
    Database db;
    db.Add({2019, 1, 1}, "e1");
    ...
    AssertEqual(db.FindIf(predicate).size(), static_cast<size_t>(1), "Db Find 4");
  }

  {
    ...
    AssertEqual(db.FindIf(predicate).size(), static_cast<size_t>(2), "Db Find 5");
  }
